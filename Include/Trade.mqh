...
//|                                              http://www.mql5.com |
//+------------------------------------------------------------------+
//updating for GenesisMarkets (Crpyot Currency Exchange)
   //digits=8; instead of the value 5 for proper logging
#include <Object.mqh>
...
//--- clean
   str="";
//--- set up
   int digits=8;// CryptoCurrencies : July 8th, 2018 @Hedgebitcoin
   if(request.symbol!=NULL)
     {
      if(symbol.Name(request.symbol))
         digits=symbol.Digits();
